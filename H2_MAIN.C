...
void H2_GameRealLoop(void)
{
   if (!gbH2_MAIN_DONE) return;
...
static void DrawAndBlit(void)
{
   ...
   #ifdef __OS2_VERSION_JUL__
   if (paused)
      WinSendMsg (hWndClient, WM_GAME_RUNNING, FALSE, 0);
   else
      WinSendMsg (hWndClient, WM_GAME_RUNNING, TRUE, 0);
   #endif
